...
#define RowsHelping 12 // Rows of global memory to be loaded into shared (for the exercise NumberOfRows + 4)
#define ColumnsHelping 36 // Columns of global memory to be loaded into shared (for the exercise TileSize + 4)
